  ...
  <div class="en-CategoryForm">
    ...
    <v-card elevation="10" class="pa-5">
      ...
      >
        ...
        <div class="en-CategoryForm-content-row">
          <b-form-tags input-id="tags-basic" v-model="Tags" class="mb-2" placeholder="Tags"></b-form-tags>
        </div>

        <div class="en-CategoryForm-content-row">
          <div v-if="!image" class="en-CategoryForm-content-row-element">
            <label for="category-upload" class="custom-file-upload" style="width: 100%">
              <v-icon style="color: white;">mdi-upload</v-icon>Icon Upload
            </label>
        ...
        <div class="en-categoryForm-content-button" style="text-align: center">
          <div class="en-CategoryForm-content-button-TheButton">
            <buttonWithColors btn-color="RedBtn" btn-label="Add Category" />
          </div>
        </div>
      </form>
    </v-card>
...
export default {
  ...
  //       });
  //     }
  //     if (categories.length) this.rootId = categories[0]._id;
  //   });
